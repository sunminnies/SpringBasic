...
import sunmin.spring.beans.HelloSpring5Bean03Eng;
import sunmin.spring.beans.HelloSpring5Bean03Jpn;
import sunmin.spring.beans.HelloSpring5Bean03Kor;
...
public class HelloSpring5App03 {
	...
	// 인터페이스를 도입하면 확장성이 높고 유연한 코드를 작성할 수 있음
    // 또한, 객체간의 tightly coupled를 피할 수 있고 객체간의 의존성을 낮출수도 있음
	...
	// 해결 : factory 패턴을 이용해서
    // 객체생성을 전담하는 클래스를 만들어 객체생성 과정을 캡슐화 함
